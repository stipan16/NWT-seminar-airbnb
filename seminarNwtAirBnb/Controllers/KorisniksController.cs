...
namespace seminarNwtAirBnb.Controllers
{
    public class KorisniksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "KorisnikID,Ime,Prezime,email")] Korisnik korisnik)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KorisnikID,Ime,Prezime,email")] Korisnik korisnik)
        {
            if (ModelState.IsValid)
            {
